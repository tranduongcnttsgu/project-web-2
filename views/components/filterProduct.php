<sectionbn class="filter-container">
    <div class="filter-category">
        <h2 class="filter-category-title">hiện thị theo nhóm sản phẩm</h2>
        <ul class="filter-category-list">
            <li class="filter-category-item active" category="" onclick=" dispatch('user/searchCategory',this)">Tất cả danh mục</li>
            <?php
    ...
    <div class="filter-pice-controller">
        ...
        <div class="filterprice-option-1" id="filter-price-ascending" onclick="dispatch('user/searchSort','increase')">
            <i class="fa-solid fa-arrow-up-wide-short"></i> <span class="filter-price-ct-o-title-1">
                giá tiền tăng đần
            </span>
        </div>
        <div class="filterprice-option-1" id="filter-price-decrease" onclick="dispatch('user/searchSort','decrease')">
    ...
    <div class="filter-author">
        ...
        <ul class="filter-author-list">
            <li class="filter-author-item active" author="" onclick=" dispatch('user/searchAuthor',this)">Tất cả danh mục</li>
            <?php
    ...
    <div class="filter-price">
        ...
        <ul class="filter-list-price" id="list-option-filter-price">
            <li class="filter-item-price" onclick=" dispatch('user/searchPriceSelect',this)">
                <input type="radio" id="price-option-0" name="price" value="0-10000" checked>
                <label for="price-option-0">Tất cả mức giá</label>
            </li>
            <li class="filter-item-price" onclick=" dispatch('user/searchPriceSelect',this)">
                <input type="radio" id="price-option-1" name="price" value="0-50">
                <label for="price-option-1"> 0đ -50.000đ</label>
            </li>
            <li class="filter-item-price" onclick=" dispatch('user/searchPriceSelect',this)">
                <input type="radio" id="price-option-2" name="price" value="50-100">
                <label for="price-option-2"> 50.000đ -100.000đ</label>
            </li>
            <li class="filter-item-price" onclick=" dispatch('user/searchPriceSelect',this)">
                <input type="radio" id="price-option-3" name="price" value="100-150">
                <label for="price-option-3"> 100.000đ -150.000đ</label>
            </li>
            <li class="filter-item-price" onclick=" dispatch('user/searchPriceSelect',this)">
                <input type="radio" id="price-option-4" name="price" value="150-200">
                <label for="price-option-4"> 150.000đ -200.000đ</label>
            </li>
            <li class="filter-item-price" onclick=" dispatch('user/searchPriceSelect',this)">
                <input type="radio" id="price-option-5" name="price" value="200-500">
                <label for="price-option-5"> 200.000đ -500.000đ</label>
            </li>
            <li class="filter-item-price" onclick=" dispatch('user/searchPriceSelect',this)">
                <input type="radio" id="price-option-6" name="price" value="500-10000">
                <label for="price-option-6">500.000đ trờ lên</label>
            </li>
        </ul>
    </div>
