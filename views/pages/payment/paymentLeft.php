<div class="bt-form-contact-simple">
    <div class="contact-item">
        ...
        <form class="form" action="" autocomplete="off" id="form-info" method="post">
            ...
            <div class="form-group">
                <textarea name="content" id="content" placeholder="Nội dung ghi chú" class="form-input form-content"></textarea>
    ...
    <div class="contact-item">
        <h2 class="contact-title">Thông tin đơn hàng</h2>
        <p class="desc-info">
        ...
        <ul class="info-list">
            ...
            <li class="info-item">
                ...
                <p class="info-text" id="info-phone">
